        ...
        <div class="row ml-2">
            ...
            <div class="col-6 mt-2">
                ...
                <div class="form-group row mb-1 pr-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="value[]" id="" placeholder="CPU">
                    </div>
                    @error('value')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="form-group row mb-1 pr-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="value[]" id="" placeholder="RAM">
                    </div>
                    @error('value')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="form-group row mb-1 pr-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="value[]" id="" placeholder="Ổ cứng">
                    </div>
                    @error('value')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="form-group row mb-1 pr-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="value[]" id="" placeholder="Card đồ họa">
                    </div>
                    @error('value')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="form-group row pr-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="value[]" id="" placeholder="Màn hình">
                    </div>
                    @error('value')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
            ...
            <div class="form-group col-12 pr-2">
                ...
                <input name="desc_short" class="form-control pr-2"></input>
            </div>
            <div class="form-group col-12 pr-2">
                <label for="">Mô tả</label>
                <textarea name="desc" rows="4" id="ckeditor1" class="form-control pr-2"></textarea>
            </div>
