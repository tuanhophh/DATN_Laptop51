...
<!-- iCheck -->
<link rel="stylesheet"type="text/css" href="{{asset('adminlte')}}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
<!-- JQVMap -->
<link rel="stylesheet"type="text/css" href="{{asset('adminlte')}}/plugins/jqvmap/jqvmap.min.css">
<!-- Theme style -->
...
<!-- summernote -->
<link rel="stylesheet"type="text/css" href="{{asset('adminlte')}}/plugins/summernote/summernote-bs4.min.css">
{{-- <link rel="stylesheet" href="/public/customize/css/style.css"> --}}
