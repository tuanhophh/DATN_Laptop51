            ...
            <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                    ...
                    <form class="form" enctype="multipart/form-data"
                        action="{{ URL::to('/profile/update-info') }}" method="POST" novalidate="">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="custom-textarea px-0" name="description" id="" cols="10" rows="3">{{ $user->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <tbody>
                                @foreach ($bill as $item)
                                    <tr class="">
                                        ...
                                        <td class="align-middle">
                                            <a data-bs-toggle="collapse"
                                                data-bs-target="#collapseFour{{ $item->id }}" aria-expanded="false"
                                                aria-controls="collapseFour{{ $item->id }}">
                                    ...
                                    <td colspan="12" class="p-0 border-0">
                                        <div id="collapseFour{{ $item->id }}" class="collapse"
                                                    ...
                                                    @foreach ($bill_user as $bill_u)
                                                        @if ($bill_u->bill_code == $item->code)
                                                            <dl class="row mb-0">
                                                                ...
                                                                <dd class="col-sm-9">
                                                                    <textarea class="p-0" name="" id="" disabled cols="10" rows="2">{{ $bill_u->note }}</textarea>
                                                                </dd>
                                                            </dl>
                                                        @endif
                                                    @endforeach
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @endif
                                                @endforeach
                                                <h5 class="card-header order-total-price text-end">Tổng:
