		...
		<div class="template-section template-section-padding-1 template-clear-fix template-main">
			...
			<div class="template-layout-33x66 template-clear-fix">
				...
				<div class="template-layout-column-left">
					<img src="{{ asset('client') }}/media/image/sample/460x678/image_01.jpg" alt="" />
				</div>
					...
					<div
						...
						<ul class="template-layout-50x50 template-clear-fix">
							...
							<li class="template-layout-column-right template-margin-bottom-reset">
								...
								<h5>Contacting Us</h5>
								<ul class="template-component-list">
									<li><span class="template-icon-meta-check"></span>We are very open and easy to reach
										company</li>
									<li><span class="template-icon-meta-check"></span>Our email is checked hourly during
										the day</li>
									<li><span class="template-icon-meta-check"></span>Book an appointment online under 3
										minutes</li>
		...
		<div
			...
			<div class="template-main">
				...
				<div class="template-component-header-subheader">
					...
					<div></div>
					<span>Chúng tôi biết thời gian của bạn rất có giá trị</span>
				</div>
					...
					<div class="template-component-feature-list template-component-feature-list-position-top">
						...
						<ul class="template-layout-50x50 template-clear-fix">
							...
							<li class="template-layout-column-left">
								...
								<h5>Thuận Tiện</h5>
								<p>Chúng tôi cam kết cung cấp dịch vụ chất lượng, sự hài lòng của khách hàng với giá trị
									lớn ở nhiều địa điểm cung cấp giờ thuận tiện.</p>
							</li>
							...
							<li class="template-layout-column-left">
								...
								<h5>Đội Ngũ Giàu Kinh Nghiệm</h5>
								<p>Tất cả các thành viên phi hành đoàn của chúng tôi đều được đào tạo và có tay nghề cao
									và được trang bị đầy đủ các thiết bị và vật tư cần thiết để chúng tôi có thể mang
							...
							<li class="template-layout-column-right">
								...
								<h5>GIÁ TRỊ LỚN</h5>
								<p>Chúng tôi cung cấp nhiều dịch vụ với giá trị lớn để đáp ứng nhu cầu của bạn. Chúng
									tôi cung cấp dịch vụ cao cấp trong khi tiết kiệm thời gian và tiền bạc của bạn.</p>
							</li>
