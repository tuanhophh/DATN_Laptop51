            ...
            <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                <ul>
                    ...
                    <li data-index="slide-1" data-transition="fade" data-slotamount="1" data-easein="default"
                        ...
                        <!-- Main image -->
                        <img src="{{ asset('client') }}/media/image/slider/slider_01.jpg" alt="slide-1" data-bgfit="cover"
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['center','center','center','center','center']"
                            ...
                            data-fontweight="['800','800','800','800','1000']"
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['center','center','center','center','center']"
                            data-hoffset="['0','0','0','0','0']"
                            data-y="['middle','middle','middle','middle','middle']"
                            data-voffset="['-41','-35','-29','17','26']" data-fontsize="['40','55','43','29','22']"
                            data-fontweight="['1000','1000','1000','800','800']"
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['center','center','center','center','center']"
                            data-hoffset="['0','0','0','0','0']"
                            data-y="['middle','middle','middle','middle','middle']"
                            data-voffset="['41','35','29','60','74']" data-fontsize="['40','55','43','29','22']"
                            data-fontweight="['1000','1000','1000','800','800']"
                            data-lineheight="['62','55','43','29','32']"
                            data-whitespace="['nowrap','nowrap','nowrap','nowrap','normal']"
                            data-width="['auto','auto','auto','auto','300']" data-height="auto"
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['center','center','center','center','center']"
                            ...
                            data-fontweight="['500','500','500','500','500']"
                    ...
                    <!-- Slide 2 -->
                    <li data-index="slide-2" data-transition="fade" data-slotamount="1" data-easein="default"
                        data-easeout="default" data-masterspeed="500" data-rotate="0" data-delay="6000">
                        <!-- Main image -->
                        <img src="{{ asset('client') }}/media/image/slider/slider_02.jpg" alt="slide-2" data-bgfit="cover"
                            data-bgposition="center bottom">
                        <!-- Layers -->
                        <!-- Layer 01 -->
                        <div class="tp-caption tp-resizeme" data-x="['center','center','center','center','center']"
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['center','center','center','center','center']"
                            ...
                            CHÚNG TÔI YÊU CHIẾC LAPTOP CỦA BẠN
                        </div>
                    ...
                    <!-- Slide 3 -->
                    <li data-index="slide-3" data-transition="fade" data-slotamount="1" data-easein="default"
                        data-easeout="default" data-masterspeed="500" data-rotate="0" data-delay="6000">
                        <!-- Main image -->
                        <img src="{{ asset('client') }}/media/image/slider/slider_03.jpg" alt="slide-3" data-bgfit="cover"
                            data-bgposition="center bottom">
                        <!-- Layers -->
                        <!-- Layer 01 -->
                        <div class="tp-caption tp-resizeme" data-x="['center','center','center','center','center']"
                            ...
                            Từng chi tiết nhỏ từ bên trong lẫn bên ngoài
                        </div>
