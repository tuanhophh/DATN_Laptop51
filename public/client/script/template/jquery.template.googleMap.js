...
;(function($,doc,win) 
{
	...
	var templateGoogleMap=function(object,option)
	{
		...
		this.build=function() 
		{
            ...
            /* lp */
            var iframe='<iframe style="border:0" width="'+$option.dimension.width+'" height="'+$option.dimension.height+'" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA2LLXoPbK_YPWDdpwgHaG3-PFYl6KiWhI&center='+$option.coordinate.lat+','+$option.coordinate.lng+'&q='+$option.coordinate.lat+','+$option.coordinate.lng+'&zoom=16" allowfullscreen="" frameborder="0"></iframe>';
            mapBoxContent.append(iframe);
            return;
            /* /lp */ 
